...
2. Create the external Hyper-V switch on the intended WAN adapter. Never bridge it to a trusted LAN.
3. Run `nix develop`, `make seeds`, and `make hyperv` from WSL. Install Debian/Ubuntu with the generated seed media, then run `make apply`.
